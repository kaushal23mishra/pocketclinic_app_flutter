...
class CommonColor {
  ...
  static const Color lightGreen = Color(0xff3fb422);
  static const Color deepGreen = Color(0xff012622);
  ...
  static const Color vibrantPurple = Color(0xff481ee5);
  static const Color deepRed = Color(0xff801336);
  ...
  static const Color silver = Color(0xff6A6A6A);
  ...
  static final List<Color> customSubNavigationDrawerBackgroundColor = [
    Colors.blue,
    Colors.red,
    const Color(0xffec94be),
    const Color(0xffa2d8f4),
    const Color(0xffa2d8f4),
    const Color(0xfff6b336),
    const Color(0xfff6b336),
  ];
